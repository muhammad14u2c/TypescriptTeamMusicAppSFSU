...
export function SmpKey({
  note,
  sampler,
  minor,
  index,
}: SmpKeyProps): JSX.Element {
  /**
...
function Smp({ synth, setSynth }: InstrumentProps): JSX.Element {
  const keys = List([
    { note: 'C', idx: 0 },
    { note: 'Db', idx: 0.5 },
    { note: 'D', idx: 1 },
...
export const SmpInstrument = new Instrument('Smp', Smp);

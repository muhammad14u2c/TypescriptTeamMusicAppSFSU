...
export interface InstrumentProps {
  state: AppState; //set by reducer before handed to app 
  dispatch: React.Dispatch<DispatchAction>; //updated by reducer upon event 
  name: string; //set by constructor upon export of individual instrument 
  synth: Tone.Synth; //set by componet definition 
  setSynth: (f: (oldSynth: Tone.Synth) => Tone.Synth) => void; // set by componet at definition 
}
